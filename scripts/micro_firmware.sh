...
sleep 1
echo -e "${COLOR}write esp8266-20171101-v1.9.3.bin${NC}"
esptool.py --port "$DEVICE" write_flash -fm dio 0x00000 ~/git/micropython/firmware/esp8266-20171101-v1.9.3.bin
sleep 1
