...
esptool.py --port "$DEVICE" write_flash -fm qio 0x00000 ~/git/micropython/firmware/esp8266-20180511-v1.9.4.bin
sleep 1
echo -e "${COLOR}write esp_init_data_default.bin${NC}"
esptool.py --port "$DEVICE" write_flash -fm qio 0x3fc000 ~/git/micropython/firmware/esp_init_data_default.bin
